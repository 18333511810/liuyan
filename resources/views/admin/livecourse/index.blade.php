	...
	<table class="table table-border table-bordered table-bg">
		...
		@foreach($data as $v)
			<tr class="text-c">
				...
				<td><input onclick="get_push({{$v->id}},{{$v->stream_id}})" class="btn btn-success-outline radius" type="button" value="推流地址"></td>
...
*/
//生成直播流的
function get_push(id,stream_id){
	layer_show('推流地址','{{url("admin/livecourse/get_push")}}/'+id+'/'+stream_id,800,200);
}
/*直播流-增加*/
function live_add(){
