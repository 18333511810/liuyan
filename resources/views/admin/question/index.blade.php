...
<div class="page-container">
	...
	<div id="filePicker">导入试题</div>
	<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>


	<a href="javascript:;" onclick="question_add()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加试题</a>
	<a href="javascript:;" onclick="question_export({{$paper->id}})" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>导出试题</a>
	...
	<table class="table table-border table-bordered table-bg">
		<thead>
			<tr>
				<th scope="col" colspan="12">试题列表</th>
			</tr>
			<tr class="text-c">
				<th width="25"><input type="checkbox" name="" value=""></th>
				<th width="40">ID</th>
				<th width="150">试题名称</th>
				<th width="50">试题的分值</th>
				<th width="50">试题的类型</th>
				<th>选项A</th>
				<th>选项B</th>
				<th>选项C</th>
				<th>选项D</th>
...
var uploader = WebUploader.create({
		...
		server: '{{url("admin/question/import")}}/{{$paper->id}}',
...
function question_export(id){
	//触发什么操作，触发的操作就是，跳到PHP文件中，有PHP文件完成导出功能
	window.location.href = "{{url('admin/question/export')}}/"+id;
}
/*
	参数解释：
	title	标题
