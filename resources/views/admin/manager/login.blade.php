...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="{{url('admin/loginok')}}" method="post">
    {{csrf_field()}}
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <input class="input-text size-L" value="{{old('captcha')}}" name="captcha" type="text" placeholder="验证码" style="width:150px;">
          <img id="showcaptcha" src="{{captcha_src()}}" style="cursor: pointer;"> <span>{{$errors->first('captcha')}}</span> </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
