...
<body>
            ...
            <div class="course-cont">
                <div class="course-cont-top-video" style="position: relative;height:500px;">
                    ...
                    <div class="video-box" style='width:986px;'>
                        ...
                        <div id="showvideo" class="video text-center" style='width:900px;height:450px;background-color:pink;clear:both;margin:auto;'>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="{{asset('admins')}}/ckplayer/ckplayer.js" charset="utf-8"></script>
    <script>
        $(function() {
            var flashvars={
                f:"{{$url}}",
            ...
            CKobject.embedSWF('/admins/ckplayer/ckplayer.swf', 'showvideo', '在线直播', '600', '400', flashvars,params);
